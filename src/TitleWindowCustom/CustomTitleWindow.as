package TitleWindowCustom {
	...
	[Event(name="windowResizeStart", type="TitleWindowCustom.CustomTitleWindowBoundsEvent")]
	[Event(name="windowResizing", type="TitleWindowCustom.CustomTitleWindowBoundsEvent")]
	[Event(name="windowResize", type="TitleWindowCustom.CustomTitleWindowBoundsEvent")]
	[Event(name="windowResizeEnd", type="TitleWindowCustom.CustomTitleWindowBoundsEvent")]
	...
	public class CustomTitleWindow extends TitleWindow {
		...
		protected function resizeHandle_mouseUpHandler(event:Event):void {
			...
			if (startResizeBounds) {
				...
				startResizeBounds = null;
				CursorManager.removeCursor(CursorManager.currentCursorID);
				var lastCurs:String =  FlexGlobals.topLevelApplication.lastCursor;
				if (lastCurs == null) lastCurs = "Default";
				SiteContainer.dispatchEvent(new TemplateEvent(TemplateEvent.UPDATE_CURSOR,false,false,lastCurs));
		...
		protected function savePanel():void {
			savedWindowRect = new Rectangle(x, y, width, parent.height);
		}
