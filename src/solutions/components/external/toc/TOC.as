package solutions.components.external.toc
{
	...
	import solutions.components.external.toc.tocClasses.TocItem;
	import solutions.components.external.toc.tocClasses.TocItemRenderer;
	import solutions.components.external.toc.tocClasses.TocMapLayerItem;
	...
	public class TOC extends Tree
	{
	    ...
	    public function TOC(map:Map = null)
	    {
			...
			setStyle("textRollOverColor","black");
			setStyle("textSelectedColor","black");
			setStyle("disclosureOpenIcon", minus);
			setStyle("disclosureClosedIcon", plus);
			//End My Add
	    }
		...
		public var showMetaButton:Boolean = false;
		...
		public var layerMain:ArrayCollection;
	    ...
	    private function registerAllMapLayers():void
	    {
	        ...
	        //MapUtil.forEachMapLayer(map, function(layer:Layer):void
	        //{
			for each(var lr:Layer in layerMain){
				registerMapLayer(lr);
			}
	        //});
	    ...
	    private function registerMapLayer(layer:Layer):void
	    {
			...
			_tocRoots.sort=numericDataSort;
			_tocRoots.refresh();
			trace(_tocRoots[0].toString());*/
	    }
